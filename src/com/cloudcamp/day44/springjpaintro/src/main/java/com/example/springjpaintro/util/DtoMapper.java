...
public class DtoMapper {
  ...
  public static SpecialityEntity mapToSpecialityEntity(SpecialityDto specialityDto) {
    SpecialityEntity specialityEntity = new SpecialityEntity();
    specialityEntity.setId(specialityEntity.getId());
    specialityEntity.setName(specialityDto.getName());
    specialityEntity.setDescription(specialityDto.getDescription());
